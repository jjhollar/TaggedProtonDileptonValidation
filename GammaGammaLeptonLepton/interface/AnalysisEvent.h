#ifndef TaggedProtonDileptonValidation_GammaGammaLeptonLepton_AnalysisEvent_h
#define TaggedProtonDileptonValidation_GammaGammaLeptonLepton_AnalysisEvent_h
...
namespace ggll
{
  ...
  class AnalysisEvent
  {
    public:
      ...
      int ProtCand_rpid1[MAX_PRO], ProtCand_rpid2[MAX_PRO], ProtCand_arm[MAX_PRO], ProtCand_ismultirp[MAX_PRO];
      double ProtCand_trackx1[MAX_PRO], ProtCand_trackx2[MAX_PRO], ProtCand_tracky1[MAX_PRO], ProtCand_tracky2[MAX_PRO];
